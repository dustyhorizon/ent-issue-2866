...
// The OneFunc type is an adapter to allow the use of ordinary
// function as One mutator.
type OneFunc func(context.Context, *generated.OneMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f OneFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	mv, ok := m.(*generated.OneMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.OneMutation", m)
	}
	return f(ctx, mv)
}

// The TwoFunc type is an adapter to allow the use of ordinary
// function as Two mutator.
type TwoFunc func(context.Context, *generated.TwoMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f TwoFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	mv, ok := m.(*generated.TwoMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.TwoMutation", m)
	}
	return f(ctx, mv)
}
