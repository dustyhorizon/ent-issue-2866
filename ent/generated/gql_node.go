...
func (o *One) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     o.ID,
		Type:   "One",
		Fields: make([]*Field, 1),
	...
	var buf []byte
	if buf, err = json.Marshal(o.Something); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
...
func (t *Two) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     t.ID,
		Type:   "Two",
		Fields: make([]*Field, 1),
	...
	var buf []byte
	if buf, err = json.Marshal(t.Something); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case one.Table:
		query := c.One.Query().
			Where(one.ID(id))
		query, err := query.CollectFields(ctx, "One")
		if err != nil {
			return nil, err
		}
	...
	case two.Table:
		query := c.Two.Query().
			Where(two.ID(id))
		query, err := query.CollectFields(ctx, "Two")
		if err != nil {
			return nil, err
		}
		n, err := query.Only(ctx)
